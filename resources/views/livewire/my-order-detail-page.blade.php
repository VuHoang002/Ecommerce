                    ...
                    <div class="mt-1 flex items-center gap-x-2">
                        @php
                            ...
                            if ($order->status == 'cancelled') {
                                $status = '<span
                                            class="bg-red-700 py-1 px-3 rounded text-white shadow">Cancelled</span>';
                            }
                        @endphp
                        {!! $status !!}
                    </div>
        ...
        <div class="md:w-3/4">
                            ...
                            <tr wire:key="{{ $item->id }}">
                                <td class="py-4">
                                    <div class="flex items-center">
                                        <img class="h-16 w-16 mr-4" src="{{ Storage::url($item->product->images[0]) }}"
            ...
            <div class="bg-white overflow-x-auto rounded-lg shadow-md p-6 mb-4">
                ...
                <div class="flex justify-between items-center">
                    <div>
                        <p>{{ $address->street_address }}, {{ $address->city }}, {{ $address->district }},
                            {{ $address->zip_code }}</p>
                    </div>
                    <div>
